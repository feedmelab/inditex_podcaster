...
exports.loadAxiosProgress = loadAxiosProgress;
...
var updatePercentage = function updatePercentage(e) {
    return _nprogress2.default.inc(calculatePercentage(e.loaded, e.total));
};

function loadAxiosProgress(config) {
    ...
    var setupUpdateProgress = function setupUpdateProgress() {
        _axios2.default.defaults.onDownloadProgress = updatePercentage;
        _axios2.default.defaults.onUploadProgress = updatePercentage;
    };
